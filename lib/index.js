...
function initCanvas() {
  ...
  // added this line because localstorage highscore was being reset to the score of the last game everytime because highscore value wasn't being update, therefore the current score was always the highscore
